        ...
        for i in range(2):
            if target_is_output[i]:
                ...
                if target[i] in bots:
                    ...
                    found |= bots[target[i]].process(bots, outputs, inputs)
                else:
    ...
    for line in input_file:
        ...
        if line.startswith("value"):
            ...
            if bot_id in bots:
                ...
                found = bots[bot_id].process(bots, outputs, inputs)
                if found:
                    break
            else:
        ...
        # print("bots:", sorted(bots.values(), key=lambda b: b.id))
        # print("bots with values:", sorted([b for b in bots.values() if b.values], key=lambda b: b.id))
        # print("inputs:", inputs)
